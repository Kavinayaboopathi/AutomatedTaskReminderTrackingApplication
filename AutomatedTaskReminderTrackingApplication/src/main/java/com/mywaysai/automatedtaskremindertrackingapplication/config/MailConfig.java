...
public class MailConfig {
    ...
    public JavaMailSender javaMailSender() {
        ...
        mailSender.setHost("smtp.gmail.com");
        mailSender.setPort(587);
        mailSender.setUsername("kaviboopathibs@gmail.com");
        
        
        //mailSender.setPassword("yycixbhcgswijhal"); //
        //mailSender.setPassword("nejkrnkeamnjiged");//rlfu gixj bsve nmjx
        mailSender.setPassword("qebk exzs vecu cpdc");
        Properties props = mailSender.getJavaMailProperties();
        props.put("mail.transport.protocol", "smtp");
        ...
        props.put("mail.smtp.from","kaviboopathibs@gmail.com");
